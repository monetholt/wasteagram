...
public final class R {
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #ColorStateListItem_alpha edu.oregonstate.holtm.wasteagram:alpha}</code></td><td>Alpha multiplier applied to the base color.</td></tr>
     * </table>
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name edu.oregonstate.holtm.wasteagram:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority edu.oregonstate.holtm.wasteagram:fontProviderAuthority}</code></td><td>The authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts edu.oregonstate.holtm.wasteagram:fontProviderCerts}</code></td><td>The sets of hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy edu.oregonstate.holtm.wasteagram:fontProviderFetchStrategy}</code></td><td>The strategy to be used when fetching font data from a font provider in XML layouts.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchTimeout edu.oregonstate.holtm.wasteagram:fontProviderFetchTimeout}</code></td><td>The length of the timeout during fetching.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderPackage edu.oregonstate.holtm.wasteagram:fontProviderPackage}</code></td><td>The package for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery edu.oregonstate.holtm.wasteagram:fontProviderQuery}</code></td><td>The query to be sent over to the provider.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name edu.oregonstate.holtm.wasteagram:fontProviderAuthority
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name edu.oregonstate.holtm.wasteagram:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name edu.oregonstate.holtm.wasteagram:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name edu.oregonstate.holtm.wasteagram:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name edu.oregonstate.holtm.wasteagram:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name edu.oregonstate.holtm.wasteagram:fontProviderQuery
     */
     ...
     * <tr><td><code>{@link #FontFamilyFont_font edu.oregonstate.holtm.wasteagram:font}</code></td><td>The reference to the font file to be used.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontStyle edu.oregonstate.holtm.wasteagram:fontStyle}</code></td><td>The style of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontVariationSettings edu.oregonstate.holtm.wasteagram:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight edu.oregonstate.holtm.wasteagram:fontWeight}</code></td><td>The weight of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_ttcIndex edu.oregonstate.holtm.wasteagram:ttcIndex}</code></td><td>The index of the font in the tcc font file.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name edu.oregonstate.holtm.wasteagram:font
     */
     ...
     * </table>
     *
     * @attr name edu.oregonstate.holtm.wasteagram:fontStyle
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name edu.oregonstate.holtm.wasteagram:fontVariationSettings
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name edu.oregonstate.holtm.wasteagram:fontWeight
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name edu.oregonstate.holtm.wasteagram:ttcIndex
     */
